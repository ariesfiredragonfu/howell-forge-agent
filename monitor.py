...
def check_ssl():
    ...
    try:
        ...
        # Parse notAfter (e.g. "Feb 12 23:59:59 2026 GMT")
...
def main() -> int:
    ...
    biofeedback.append_constraint("MONITOR", f"Site check failed — {msg}")
    telegram_msg = f"🔴 [{severity}] Monitor: Site check failed — {msg}"
    send_telegram_alert(telegram_msg)
    print(f"Monitor: ALERT — {msg} (wrote to log, Telegram sent)")
    return 1
